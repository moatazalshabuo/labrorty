    ...
    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
        <div class="card  box-shadow-0">
            <div class="card-header">
                <h4 class="card-title mb-1">اضافة التحاليل</h4>
            </div>
            <div class="card-body pt-0">
                ...
                <form method="POST" action="{{ route('lab_tests.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="name" type="text"
                                ...
                                placeholder="اسم التحليل" value="{{ old('name') }}" required autocomplete="name"
                                autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="descripe" type="text"
                                ...
                                placeholder="وصف" value="{{ old('descripe') }}" autocomplete="descripe"
                                autofocus>
                    ...
                    <div class="form-group">
                        <label for="group_id" class="col-form-label text-md-end">لمجوعة </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input id="unit" type="text"
                                ...
                                placeholder="وحدة القياس" value="{{ old('unit') }}" required autocomplete="unit"
                                autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input id="normal_form" type="text"
                                        class="form-control @error('normal_form') is-invalid @enderror" name="normal_form"
                                        placeholder="المعدل الطبيعي" value="{{ old('normal_form') }}" required autocomplete="normal_form"
                                        autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input id="normal_to" type="text"
                                        ...
                                        placeholder="المعدل الطبيعي الى" value="{{ old('normal_to') }}" required autocomplete="normal_to"
                                        autofocus>
