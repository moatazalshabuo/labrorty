                ...
                <div class="col-md-10">
                    ...
                    <div class="card" id="chat2">
                            ...
                            @foreach ($message as $item)
                                ...
                                <div class="d-flex flex-row justify-content-end mb-4 pt-1">
                                    <div>
                                        ...
                                        <p class="small me-3 mb-3 rounded-3 text-muted d-flex justify-content-end">{{ explode(' ',$item->created_at)[1] }}</p>
                                        <small class="text">{{ Helepers::user_name($item->receiver_id) }}</small>
                                    </div>
                        ...
                        <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3">
                            <i class="fa fa-users" style="font-size:30px"></i>
                                <form method="post" action="{{ route('message.send') }}" class="d-flex justify-content-start align-items-center">
                                    <div>
                                        @csrf
                                    <input type="hidden" name="client_id" value="{{$message[0]->client->id }}">
                                    <input type="hidden" name="receiver_id" value="{{ Auth::id() }}">
                                    <input type="text" class="form-control form-control-lg" name="message" id="exampleFormControlInput1"
